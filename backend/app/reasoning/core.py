...
# Deterministic output-language guard.
...
# evidence reference). Extend with clinical judgement (see REASON-05).
...
def derive_confidence_tier(hypothesis: Hypothesis) -> str:
    ...
    string. Call this only AFTER :func:`verify_citations` so we judge
...
async def run_reasoning(
    ...
    *,
    ...
    5. Apply the deterministic output-language gate: drop any hypothesis
       ...
       (#75 hardening of the output-language guard).
