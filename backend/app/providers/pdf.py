...
def _extract(path: Path, patient_id: str) -> FetchResult:
    ...
    conditions = _extract_conditions(pages, patient_id, provenance)
            ...
            conditions.append(
                {
                    ...
                    "id": condition_id,
                    # subject is required by R4B Condition — without it the resource
                    # fails the /intake boundary validator (FHIR-01/02) and is dropped.
