...
def create_app() -> FastAPI:
    ...
    # Local dev origins plus any extra origins from CORS_ALLOW_ORIGINS (comma-separated).
    # The dev server runs on 3001 (`next dev --port 3001`); 3000 is kept for custom setups.
